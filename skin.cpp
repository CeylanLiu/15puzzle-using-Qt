    ...
    QWidget(parent)
{
    ...
    connect(skin1,&QPushButton::clicked,skin1,&skin_Button::changeskin_pan_1);
    connect(skin2,&QPushButton::clicked,skin2,&skin_Button::changeskin_pan_2);
    connect(skin3,&QPushButton::clicked,skin3,&skin_Button::changeskin_pan_3);
    connect(skin4,&QPushButton::clicked,skin4,&skin_Button::changeskin_pan_0);
...
void skin::showskin_1()
{
    QImage image(QString(":/picture/background1.png"));
    this->showlabel->setPixmap(QPixmap::fromImage(image));
    this->showlabel->setScaledContents(true);
}

void skin::showskin_2()
{
    QImage image(QString(":/picture/background2.png"));
    this->showlabel->setPixmap(QPixmap::fromImage(image));
    this->showlabel->setScaledContents(true);
}

void skin::showskin_3()
{
    QImage image(QString(":/picture/background3.png"));
    this->showlabel->setPixmap(QPixmap::fromImage(image));
    this->showlabel->setScaledContents(true);
}
void skin::showskin_4()
{
    QImage image(QString(":/picture/16.png"));
    this->showlabel->setPixmap(QPixmap::fromImage(image));
    this->showlabel->setScaledContents(true);
}
void skin::noshowskin()
{
